...
def get_unique_filename(directory, original_name):
    ...
    counter = 1
    while True:
        unique_name = f"{base}_{counter}{ext}" if counter > 1 else original_name
        ...
        <style>
            ...
            @media (hover: hover) {
                .copyright-content:hover {
                    ...
                    box-shadow: 0 6px 25px rgba(255, 107, 8, 0.25);
                }
                .copyright-content:hover::before {
